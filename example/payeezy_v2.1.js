var Payeezy = function() {
    ...
    return {
        createToken: function(e) {
            ...
            var a = "https://" + n + "/v1/securitytokens?apikey=" + this.apikey + "&trtoken=" + this.trtoken + "&ta_token=" + this.ta_token+ "&callback=Payeezy.callback&auth="+r["auth"]+"&type=FDToken&credit_card.type=" + r["card_type"] + "&credit_card.cardholder_name=" + r["cardholder_name"] + "&credit_card.card_number=" + r["cc_number"] + "&credit_card.exp_date=" + r["exp_month"] + r["exp_year"] + "&credit_card.cvv=" + r["cvv_code"];
